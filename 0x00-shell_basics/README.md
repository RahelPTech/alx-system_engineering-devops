...
The Script that displays the current directory contents as Long format, with user and group IDs displayed numerically and hidden files (starting with .) is ls -l
The a script that creates a directory named my_first_directory in the /tmp/ directory is mkdir.
